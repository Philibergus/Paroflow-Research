  ...
  const patients = await Promise.all([
    ...
    prisma.patient.create({
      data: {
        ...
        notes: 'Implant 11 suite à trauma - Correspondant: Pr. Dubois (CMF) - Antécédents: RAS - Allergies: Aucune'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        notes: 'Bridge 34-36 sur 2 implants - Correspondant: Dr. Petit (Paro) - Antécédents: Diabète type 2 équilibré - Allergies: Pénicilline'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        notes: 'All-on-6 maxillaire - Correspondant: Dr. Rousseau (CMF) - Antécédents: HTA, Statines - Allergies: Latex'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        notes: 'Sinus lift bilatéral + 4 implants postérieurs - Correspondant: Dr. Moreau (ORL) - Antécédents: Tabagisme sevré 2020 - Allergies: Aucune'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        notes: 'Extraction 36 + implant immédiat - Correspondant: Dr. Garcia (Endo) - Antécédents: RAS - Allergies: Iode'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        numeroSecurite: '2681275XXX',
        notes: 'ROG secteur 2 + 3 implants différés - Correspondant: Pr. Dubois (CMF) - Antécédents: Ostéoporose - Allergies: Aucune'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        numeroSecurite: '2850675XXX',
        notes: 'Orthodontie pré-implantaire + 2 implants 15,25 - Correspondant: Dr. Lefebvre (Ortho) - Antécédents: RAS - Allergies: Nickel'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        numeroSecurite: '1620275XXX',
        notes: 'Traitement péri-implantite 46 - Correspondant: Dr. Petit (Paro) - Antécédents: Bruxisme - Allergies: Aucune'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        numeroSecurite: '2721075XXX',
        notes: 'Implants 14-16 mise en charge immédiate - Correspondant: Dr. Leroy (Radio) - Antécédents: Hypothyroïdie - Allergies: Aucune'
      }
    }),
    ...
    prisma.patient.create({
      data: {
        ...
        numeroSecurite: '1600175XXX',
        notes: 'Communication bucco-sinusienne post-extraction 26 - Correspondant: Dr. Moreau (ORL) - Antécédents: Sinusite chronique - Allergies: Aspirine'
      }
    })
  ])
